...
/**
 * upload de arquivo de procedimento
 *  
 * By Alat
 */
    ...
    switch ($fase) {
        ...
        case "upload" :
            ...
            if (file_exists("{$pasta}{$id}.pdf")) {
                ...
                $botaoApaga->set_title("Exclui o Arquivo cadastrado");
        ...
        case "apagaDocumento" :
            ...
            if (rename("{$pasta}{$id}.jpg", "{$pasta}_apagados/{$id}_" . $intra->get_usuario($idUsuario) . "_" . date("Y.m.d_H:i") . ".jpg")) {
